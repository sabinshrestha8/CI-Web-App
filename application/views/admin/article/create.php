                ...
                <div class="card card-primary">
                    ...
                    <form action="<?php echo base_url() . 'admin/article/create' ?>" name="categoryForm" id="categoryForm" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label>Title</label>
                                <input type="text" name="title" id="title" class="form-control <?php echo (form_error('title') != "") ? 'is-invalid' : ''; ?>" value="<?php echo set_value('title'); ?>">
                                <?php
                            ...
                            <div class="form-group">
                                <label>Author</label>
                                <input type="text" class="form-control <?php echo (form_error('author') != "") ? 'is-invalid' : ''; ?>" name="author" value="<?php echo set_value('author'); ?>">
                                <?php
                            ...
                            <div class="custom-control custom-radio float-left">
                                <input type="radio" class="custom-control-input" value="1" id="statusActive" name="status">
