    ...
    <div class="login-box">
        ...
        <div class="card">
            <div class="card-body login-card-body">
                ...
                <form action="<?php echo base_url() . 'admin/login/register' ?>" name="loginForm" id="loginForm" method="post">
                    ...
                    <?php echo "<div class='alert-danger mb-3'>" . form_error('username') . "</div>"; ?>
                    <div class="input-group mb-3">
                    ...
                    <?php echo "<div class='alert-danger mb-3'>" . form_error('password') . "</div>"; ?>
                    <div class="row">
                        <div class="col-8">
